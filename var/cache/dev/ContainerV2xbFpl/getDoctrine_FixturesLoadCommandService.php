...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/BilletsFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/CategoriesFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/EvenementsFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ImagesEventFixtures.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/TypeBilletsFixtures.php';
        ...
        $a->addFixtures([['fixture' => new \App\DataFixtures\AppFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\BilletsFixtures($b), 'groups' => []], ['fixture' => new \App\DataFixtures\CategoriesFixtures($b), 'groups' => []], ['fixture' => new \App\DataFixtures\EvenementsFixtures($b), 'groups' => []], ['fixture' => new \App\DataFixtures\ImagesEventFixtures(), 'groups' => []], ['fixture' => new \App\DataFixtures\TypeBilletsFixtures($b), 'groups' => []], ['fixture' => new \App\DataFixtures\UsersFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService')), $b), 'groups' => []]]);
